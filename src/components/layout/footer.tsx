      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/brand-strategy" className="text-muted-foreground hover:text-primary transition-colors">
                  Brand Strategy
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-muted-foreground mb-2">123 Marketing Street</p>
              <p className="text-muted-foreground mb-2">New York, NY 10001</p>
              <p className="text-muted-foreground mb-2">
                <a href="mailto:info@nexusmarketing.com" className="hover:text-primary transition-colors">
                  info@nexusmarketing.com
                </a>
              </p>
              <p className="text-muted-foreground mb-2">
